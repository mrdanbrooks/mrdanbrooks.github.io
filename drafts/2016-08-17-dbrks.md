...
It had never occured to me that I could run my own URL shortener until a few days ago when I received an email from a friend in which he included several shortened URLs hosted by his own server. 
...
Unfortunately, this means that my brand new short URL, <http://dbrks.co>, would need to be pointed at a rather long URL to begin with <http://www.cs.uml.edu/~dbrooks/links>.
Also, that is not really how DNS works.
